        ...
        try {
            ...
            for (let i = 0; i < entries.length; i++) {
                ...
                try {
                    ...
                    // hexo-generator-searchdb: link may be <url> or <link>
                    let url = '';
                    ...
                    for (let j = 0; j < catElements.length; j++) {
                        const term = catElements[j].getAttribute('term');
                        const text = catElements[j].textContent;
                        if (term) categories.push(term);
                        else if (text) categories.push(text);
                    }
